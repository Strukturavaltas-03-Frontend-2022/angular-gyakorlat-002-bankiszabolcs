...
describe('PricingPageComponent', () => {
  ...
  it('első név: Free', () => {
    ...
    expect(
      compiled.querySelector('.card:first-child h4').textContent
    ).toContain('Free');
  });
  it('második név: Pro', () => {
    fixture.detectChanges();
    const compiled = fixture.nativeElement;
    expect(
      compiled.querySelector('.card:nth-child(2) h4').textContent
    ).toContain('Pro');
  });
  it('harmadik név: Enterprise', () => {
    ...
    const compiled = fixture.nativeElement;
    expect(
      compiled.querySelector('.card:nth-child(3) h4').textContent
  ...
  it('első ár: $0', () => {
    ...
    const content = compiled.querySelector(
      '.card:nth-child(1) .card-body .pricing-card-title'
    ).textContent;
  ...
  it('második ár: $15', () => {
    ...
    const compiled = fixture.nativeElement;
    const content = compiled.querySelector(
      '.card:nth-child(2) .card-body .pricing-card-title'
    ).textContent;
  ...
  it('harmadik ár: $29', () => {
    ...
    const compiled = fixture.nativeElement;
    const content = compiled.querySelector(
      '.card:nth-child(3) .card-body .pricing-card-title'
    ).textContent;
  ...
  it('első opciók egyeznek', () => {
    ...
    const compiled = fixture.nativeElement;
    const content = compiled.querySelector(
      '.card:nth-child(1) .card-body .list-unstyled'
    ).textContent;
  ...
  it('második opciók egyeznek', () => {
    ...
    const compiled = fixture.nativeElement;
    const content = compiled.querySelector(
      '.card:nth-child(2) .card-body .list-unstyled'
    ).textContent;
  ...
  it('harmadik opciók egyeznek', () => {
    ...
    const compiled = fixture.nativeElement;
    const content = compiled.querySelector(
      '.card:nth-child(3) .card-body .list-unstyled'
    ).textContent;
